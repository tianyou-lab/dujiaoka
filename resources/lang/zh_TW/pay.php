...
return [
    ...
    'helps' => [
        ...
        'vmq_section' => 'V免簽使用 md5 簽名協議，欄位對映如下：「商戶 ID」= V免簽通訊金鑰（32 位隨機字串），「商戶金鑰」= 監控端 URL（例如 https://xxxxx.com/）。「支付處理模組 pay_handleroute」請填 vmq；微信掃碼 payway 用 vwx、支付寶掃碼 payway 用 vzfb。',
    ],
];
